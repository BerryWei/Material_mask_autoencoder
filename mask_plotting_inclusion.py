...
for i, row_axes in enumerate(axes):
    ...
    fig.text(0.09, y_center, f"Instance #{i + 1 +4}",  # Adjusted x for better positioning
...
# plt.tight_layout()
# Save results
plt.savefig(r'D:\Material_mask_autoencoder\results\pretrained_inclusion\reconstruction.png')
plt.show()