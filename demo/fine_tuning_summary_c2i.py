...
# 保存為 PDF 和 TIFF 文件
output_dir = r"D:\Material_mask_autoencoder\results\pretrained_circle\c2i_finetune"
...
for ratio in ratios:
    ...
    for comp in components:
        file_path = os.path.join(base_dir, f"c2i_{N_dataset}_finetune_circular_mr{ratio}_cls_{comp}/log.txt")
