...
ratios = ["015", "020", "025", "030", "035", "040", "045", "050", "055", "060", "065", "070", "075", "080", "085", "090"]
components = [ "C00", "C11", "C22"]
# components = ["Vf_real", "C11", "C22"]
labels = [ "$\overline{C}_{1111}$", "$\overline{C}_{2222}$", "$\overline{C}_{1212}$"]
# 保存為 PDF 和 TIFF 文件
output_dir = r"D:\Material_mask_autoencoder\results\pretrained_inclusion\i2i_linear_probing"
...
print(mask_ratios[np.argmax(average_r2)])
print(np.max(average_r2))
# 第一張子圖：平均 R2 值
...
axs[1].legend(fontsize=6, frameon=False, loc='best')
