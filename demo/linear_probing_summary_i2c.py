...
# 保存為 PDF 和 TIFF 文件
output_dir = r"D:\Material_mask_autoencoder\results\pretrained_inclusion\i2c_linear_probing"
...
for ratio in ratios:
    ...
    for comp in components:
        file_path = os.path.join(base_dir, f"i2c_{N_dataset}_linprobe_inclusion_mr{ratio}_cls_{comp}/log.txt")
