...
# 保存為 PDF 和 TIFF 文件
output_dir = r"D:\Material_mask_autoencoder\results\pretrained_circle\linear_probing"
...
for ratio in ratios:
    ...
    for comp in components:
        file_path = os.path.join(base_dir, f"c2c_linprobe_circular_mr{ratio}_cls_{comp}/log.txt")
